Int_t readMyJetPythiaCrs(const char* filelist="test.pyjets.list", const char* outfile="test.py.root")
{
...
//  cout<<nueocevnt<<endl;
  ...
  ReaderPythiaCrs *reader = new ReaderPythiaCrs(parevnt, particleevnt, pyevnt);
  ...
  reader->Init();
   /*
  //test
  double ptbins[yNPtBins] = {0., 0.26, 0.14, 0.89, 1.12, 1.22, 1.49, 2.45, 2.87,
