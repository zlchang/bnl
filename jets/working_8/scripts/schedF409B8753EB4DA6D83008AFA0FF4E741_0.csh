#!/bin/csh
# -------------------------------------- 
# Script generated on Tue Dec 04 10:53:42 EST 2018 by the STAR Unified Meta Scheduler 1.10.28 and submitted with:
# cd /star/u/zchang/jetAnalysis/jets/working_8; condor_submit /star/u/zchang/jetAnalysis/jets/working_8/scripts/schedF409B8753EB4DA6D83008AFA0FF4E741_0_2.condor
# --------------------------------------
...
setenv FILEBASENAME "13095014"
setenv FILELIST "/star/u/zchang/jetAnalysis/jets/working_8/scripts/schedF409B8753EB4DA6D83008AFA0FF4E741_0.list"
setenv FILELIST_ALL "/star/u/zchang/jetAnalysis/jets/working_8/scripts/schedF409B8753EB4DA6D83008AFA0FF4E741.list"
setenv INPUTFILECOUNT "1"
setenv JOBID "F409B8753EB4DA6D83008AFA0FF4E741_0"
setenv JOBINDEX "0"
setenv LOGGING "STD"
setenv REQUESTID "F409B8753EB4DA6D83008AFA0FF4E741"
setenv SUBMITATTEMPT "1"
setenv SUBMITTINGDIRECTORY "/star/u/zchang/jetAnalysis/jets/working_8"
setenv SUBMITTINGNODE "rcas6008.rcf.bnl.gov"
setenv SUBMIT_TIME "2018-12-04 15:53:42"
setenv SUMS_AUTHENTICATED_USER "zchang@rhic.bnl.gov"
setenv SUMS_USER "zchang"
setenv SUMS_nProcesses "3"
setenv SUMS_name "13095014.job"
setenv INPUTFILE0 "/star/u/zchang/jetAnalysis/jets/lists_jets/13095014.0.list"
...
setenv pwd `pwd` 
foreach object ( `find /star/u/zchang/jetAnalysis/jets/ -maxdepth 1 -name 'readMyJetCrs.C' ` ) 
...
# User command BEGIN ----------------------------->
        ...
        echo 13095014 readMyJetCrs.C
       /usr/bin/time root -b -q readMyJetCrs.C\(\"$INPUTFILE0\",\"13095014\.$JOBINDEX\.crs\.root\"\)
...
# Copy output files (if any where specified)
    ...
    foreach file ( $SCRATCH/13095014.$JOBINDEX.crs.root )
         set i=0
         
         if ( -d $file ) then
            set cpCommand="/bin/cp -r $file /star/u/zchang/data05/Run12JetsCrsUe/13095014/"
         else
            set cpCommand="/bin/cp -fp $file /star/u/zchang/data05/Run12JetsCrsUe/13095014/"
         endif
