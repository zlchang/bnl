#!/bin/csh
# -------------------------------------- 
# Script generated on Tue Dec 04 10:41:29 EST 2018 by the STAR Unified Meta Scheduler 1.10.28 and submitted with:
# cd /star/u/zchang/jetAnalysis/jets; condor_submit /star/u/zchang/jetAnalysis/jets/scripts/sched27D1F535970ABBC06CC74002E2DE2214_0_9.condor
# --------------------------------------
...
setenv FILEBASENAME "pt7_9"
setenv FILELIST "/star/u/zchang/jetAnalysis/jets/scripts/sched27D1F535970ABBC06CC74002E2DE2214_7.list"
setenv FILELIST_ALL "/star/u/zchang/jetAnalysis/jets/scripts/sched27D1F535970ABBC06CC74002E2DE2214.list"
setenv INPUTFILECOUNT "1"
setenv JOBID "27D1F535970ABBC06CC74002E2DE2214_7"
setenv JOBINDEX "7"
setenv LOGGING "STD"
setenv REQUESTID "27D1F535970ABBC06CC74002E2DE2214"
...
setenv SUBMIT_TIME "2018-12-04 15:41:29"
setenv SUMS_AUTHENTICATED_USER "zchang@rhic.bnl.gov"
setenv SUMS_USER "zchang"
setenv SUMS_nProcesses "10"
setenv SUMS_name "pt7_9.job"
setenv INPUTFILE0 "/star/u/zchang/jetAnalysis/jets/lists_jets/pt7_9.7.list"
...
# User command BEGIN ----------------------------->
        ...
        echo pt7_9 readMyJetCrsMc.C
       /usr/bin/time root -b -q readMyJetCrsMc.C\(\"$INPUTFILE0\",\"pt7_9\.$JOBINDEX\.crs\.root\"\)
...
# Copy output files (if any where specified)
    ...
    foreach file ( $SCRATCH/pt7_9.$JOBINDEX.crs.root )
         set i=0
         
         if ( -d $file ) then
            set cpCommand="/bin/cp -r $file /star/u/zchang/data05/Run12JetsCrsUe/pt7_9/"
         else
            set cpCommand="/bin/cp -fp $file /star/u/zchang/data05/Run12JetsCrsUe/pt7_9/"
         endif
