#!/bin/csh
# -------------------------------------- 
# Script generated on Tue Dec 04 10:41:25 EST 2018 by the STAR Unified Meta Scheduler 1.10.28 and submitted with:
# cd /star/u/zchang/jetAnalysis/jets; condor_submit /star/u/zchang/jetAnalysis/jets/scripts/sched87AE32E4731555F1ADA3F730C2B7EC16_0_9.condor
# --------------------------------------
...
setenv FILEBASENAME "pt5_7"
setenv FILELIST "/star/u/zchang/jetAnalysis/jets/scripts/sched87AE32E4731555F1ADA3F730C2B7EC16_8.list"
setenv FILELIST_ALL "/star/u/zchang/jetAnalysis/jets/scripts/sched87AE32E4731555F1ADA3F730C2B7EC16.list"
setenv INPUTFILECOUNT "1"
setenv JOBID "87AE32E4731555F1ADA3F730C2B7EC16_8"
setenv JOBINDEX "8"
setenv LOGGING "STD"
setenv REQUESTID "87AE32E4731555F1ADA3F730C2B7EC16"
...
setenv SUBMIT_TIME "2018-12-04 15:41:25"
setenv SUMS_AUTHENTICATED_USER "zchang@rhic.bnl.gov"
setenv SUMS_USER "zchang"
setenv SUMS_nProcesses "10"
setenv SUMS_name "pt5_7.job"
setenv INPUTFILE0 "/star/u/zchang/jetAnalysis/jets/lists_jets/pt5_7.8.list"
...
# User command BEGIN ----------------------------->
        ...
        echo pt5_7 readMyJetCrsMc.C
       /usr/bin/time root -b -q readMyJetCrsMc.C\(\"$INPUTFILE0\",\"pt5_7\.$JOBINDEX\.crs\.root\"\)
...
# Copy output files (if any where specified)
    ...
    foreach file ( $SCRATCH/pt5_7.$JOBINDEX.crs.root )
         set i=0
         
         if ( -d $file ) then
            set cpCommand="/bin/cp -r $file /star/u/zchang/data05/Run12JetsCrsUe/pt5_7/"
         else
            set cpCommand="/bin/cp -fp $file /star/u/zchang/data05/Run12JetsCrsUe/pt5_7/"
         endif
