#!/bin/csh
# -------------------------------------- 
# Script generated on Tue Dec 04 10:41:51 EST 2018 by the STAR Unified Meta Scheduler 1.10.28 and submitted with:
# cd /star/u/zchang/jetAnalysis/jets; condor_submit /star/u/zchang/jetAnalysis/jets/scripts/sched381285E004C2202A16F4A9B50F99A9F3_0_9.condor
# --------------------------------------
...
setenv FILEBASENAME "pt25_35"
setenv FILELIST "/star/u/zchang/jetAnalysis/jets/scripts/sched381285E004C2202A16F4A9B50F99A9F3_1.list"
setenv FILELIST_ALL "/star/u/zchang/jetAnalysis/jets/scripts/sched381285E004C2202A16F4A9B50F99A9F3.list"
setenv INPUTFILECOUNT "1"
setenv JOBID "381285E004C2202A16F4A9B50F99A9F3_1"
setenv JOBINDEX "1"
setenv LOGGING "STD"
setenv REQUESTID "381285E004C2202A16F4A9B50F99A9F3"
...
setenv SUBMIT_TIME "2018-12-04 15:41:51"
setenv SUMS_AUTHENTICATED_USER "zchang@rhic.bnl.gov"
setenv SUMS_USER "zchang"
setenv SUMS_nProcesses "10"
setenv SUMS_name "pt25_35.job"
setenv INPUTFILE0 "/star/u/zchang/jetAnalysis/jets/lists_jets/pt25_35.1.list"
...
# User command BEGIN ----------------------------->
        ...
        echo pt25_35 readMyJetCrsMc.C
       /usr/bin/time root -b -q readMyJetCrsMc.C\(\"$INPUTFILE0\",\"pt25_35\.$JOBINDEX\.crs\.root\"\)
...
# Copy output files (if any where specified)
    ...
    foreach file ( $SCRATCH/pt25_35.$JOBINDEX.crs.root )
         set i=0
         
         if ( -d $file ) then
            set cpCommand="/bin/cp -r $file /star/u/zchang/data05/Run12JetsCrsUe/pt25_35/"
         else
            set cpCommand="/bin/cp -fp $file /star/u/zchang/data05/Run12JetsCrsUe/pt25_35/"
         endif
