#!/bin/csh
# -------------------------------------- 
# Script generated on Tue Dec 04 10:41:11 EST 2018 by the STAR Unified Meta Scheduler 1.10.28 and submitted with:
# cd /star/u/zchang/jetAnalysis/jets; condor_submit /star/u/zchang/jetAnalysis/jets/scripts/sched768B2C73F52150E8AD14D00E203BAB40_0_9.condor
# --------------------------------------
...
setenv FILEBASENAME "pt2_3"
setenv FILELIST "/star/u/zchang/jetAnalysis/jets/scripts/sched768B2C73F52150E8AD14D00E203BAB40_1.list"
setenv FILELIST_ALL "/star/u/zchang/jetAnalysis/jets/scripts/sched768B2C73F52150E8AD14D00E203BAB40.list"
setenv INPUTFILECOUNT "1"
setenv JOBID "768B2C73F52150E8AD14D00E203BAB40_1"
setenv JOBINDEX "1"
setenv LOGGING "STD"
setenv REQUESTID "768B2C73F52150E8AD14D00E203BAB40"
...
setenv SUBMIT_TIME "2018-12-04 15:41:11"
setenv SUMS_AUTHENTICATED_USER "zchang@rhic.bnl.gov"
setenv SUMS_USER "zchang"
setenv SUMS_nProcesses "10"
setenv SUMS_name "pt2_3.job"
setenv INPUTFILE0 "/star/u/zchang/jetAnalysis/jets/lists_jets/pt2_3.1.list"
...
# User command BEGIN ----------------------------->
        ...
        echo pt2_3 readMyJetCrsMc.C
       /usr/bin/time root -b -q readMyJetCrsMc.C\(\"$INPUTFILE0\",\"pt2_3\.$JOBINDEX\.crs\.root\"\)
...
# Copy output files (if any where specified)
    ...
    foreach file ( $SCRATCH/pt2_3.$JOBINDEX.crs.root )
         set i=0
         
         if ( -d $file ) then
            set cpCommand="/bin/cp -r $file /star/u/zchang/data05/Run12JetsCrsUe/pt2_3/"
         else
            set cpCommand="/bin/cp -fp $file /star/u/zchang/data05/Run12JetsCrsUe/pt2_3/"
         endif
