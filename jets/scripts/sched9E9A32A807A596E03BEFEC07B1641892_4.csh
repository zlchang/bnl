#!/bin/csh
# -------------------------------------- 
# Script generated on Tue Dec 04 10:41:16 EST 2018 by the STAR Unified Meta Scheduler 1.10.28 and submitted with:
# cd /star/u/zchang/jetAnalysis/jets; condor_submit /star/u/zchang/jetAnalysis/jets/scripts/sched9E9A32A807A596E03BEFEC07B1641892_0_9.condor
# --------------------------------------
...
setenv FILEBASENAME "pt3_4"
setenv FILELIST "/star/u/zchang/jetAnalysis/jets/scripts/sched9E9A32A807A596E03BEFEC07B1641892_4.list"
setenv FILELIST_ALL "/star/u/zchang/jetAnalysis/jets/scripts/sched9E9A32A807A596E03BEFEC07B1641892.list"
setenv INPUTFILECOUNT "1"
setenv JOBID "9E9A32A807A596E03BEFEC07B1641892_4"
setenv JOBINDEX "4"
setenv LOGGING "STD"
setenv REQUESTID "9E9A32A807A596E03BEFEC07B1641892"
...
setenv SUBMIT_TIME "2018-12-04 15:41:16"
setenv SUMS_AUTHENTICATED_USER "zchang@rhic.bnl.gov"
setenv SUMS_USER "zchang"
setenv SUMS_nProcesses "10"
setenv SUMS_name "pt3_4.job"
setenv INPUTFILE0 "/star/u/zchang/jetAnalysis/jets/lists_jets/pt3_4.4.list"
...
# User command BEGIN ----------------------------->
        ...
        echo pt3_4 readMyJetCrsMc.C
       /usr/bin/time root -b -q readMyJetCrsMc.C\(\"$INPUTFILE0\",\"pt3_4\.$JOBINDEX\.crs\.root\"\)
...
# Copy output files (if any where specified)
    ...
    foreach file ( $SCRATCH/pt3_4.$JOBINDEX.crs.root )
         set i=0
         
         if ( -d $file ) then
            set cpCommand="/bin/cp -r $file /star/u/zchang/data05/Run12JetsCrsUe/pt3_4/"
         else
            set cpCommand="/bin/cp -fp $file /star/u/zchang/data05/Run12JetsCrsUe/pt3_4/"
         endif
