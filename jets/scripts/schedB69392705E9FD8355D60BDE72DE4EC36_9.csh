#!/bin/csh
# -------------------------------------- 
# Script generated on Tue Dec 04 10:41:43 EST 2018 by the STAR Unified Meta Scheduler 1.10.28 and submitted with:
# cd /star/u/zchang/jetAnalysis/jets; condor_submit /star/u/zchang/jetAnalysis/jets/scripts/schedB69392705E9FD8355D60BDE72DE4EC36_0_9.condor
# --------------------------------------
...
setenv FILEBASENAME "pt15_20"
setenv FILELIST "/star/u/zchang/jetAnalysis/jets/scripts/schedB69392705E9FD8355D60BDE72DE4EC36_9.list"
setenv FILELIST_ALL "/star/u/zchang/jetAnalysis/jets/scripts/schedB69392705E9FD8355D60BDE72DE4EC36.list"
setenv INPUTFILECOUNT "1"
setenv JOBID "B69392705E9FD8355D60BDE72DE4EC36_9"
setenv JOBINDEX "9"
setenv LOGGING "STD"
setenv REQUESTID "B69392705E9FD8355D60BDE72DE4EC36"
...
setenv SUBMIT_TIME "2018-12-04 15:41:43"
setenv SUMS_AUTHENTICATED_USER "zchang@rhic.bnl.gov"
setenv SUMS_USER "zchang"
setenv SUMS_nProcesses "10"
setenv SUMS_name "pt15_20.job"
setenv INPUTFILE0 "/star/u/zchang/jetAnalysis/jets/lists_jets/pt15_20.9.list"
...
# User command BEGIN ----------------------------->
        ...
        echo pt15_20 readMyJetCrsMc.C
       /usr/bin/time root -b -q readMyJetCrsMc.C\(\"$INPUTFILE0\",\"pt15_20\.$JOBINDEX\.crs\.root\"\)
...
# Copy output files (if any where specified)
    ...
    foreach file ( $SCRATCH/pt15_20.$JOBINDEX.crs.root )
         set i=0
         
         if ( -d $file ) then
            set cpCommand="/bin/cp -r $file /star/u/zchang/data05/Run12JetsCrsUe/pt15_20/"
         else
            set cpCommand="/bin/cp -fp $file /star/u/zchang/data05/Run12JetsCrsUe/pt15_20/"
         endif
