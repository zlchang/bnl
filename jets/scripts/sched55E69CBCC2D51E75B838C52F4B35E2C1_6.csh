#!/bin/csh
# -------------------------------------- 
# Script generated on Tue Dec 04 10:41:20 EST 2018 by the STAR Unified Meta Scheduler 1.10.28 and submitted with:
# cd /star/u/zchang/jetAnalysis/jets; condor_submit /star/u/zchang/jetAnalysis/jets/scripts/sched55E69CBCC2D51E75B838C52F4B35E2C1_0_9.condor
# --------------------------------------
...
setenv FILEBASENAME "pt4_5"
setenv FILELIST "/star/u/zchang/jetAnalysis/jets/scripts/sched55E69CBCC2D51E75B838C52F4B35E2C1_6.list"
setenv FILELIST_ALL "/star/u/zchang/jetAnalysis/jets/scripts/sched55E69CBCC2D51E75B838C52F4B35E2C1.list"
setenv INPUTFILECOUNT "1"
setenv JOBID "55E69CBCC2D51E75B838C52F4B35E2C1_6"
setenv JOBINDEX "6"
setenv LOGGING "STD"
setenv REQUESTID "55E69CBCC2D51E75B838C52F4B35E2C1"
...
setenv SUBMIT_TIME "2018-12-04 15:41:20"
setenv SUMS_AUTHENTICATED_USER "zchang@rhic.bnl.gov"
setenv SUMS_USER "zchang"
setenv SUMS_nProcesses "10"
setenv SUMS_name "pt4_5.job"
setenv INPUTFILE0 "/star/u/zchang/jetAnalysis/jets/lists_jets/pt4_5.6.list"
...
# User command BEGIN ----------------------------->
        ...
        echo pt4_5 readMyJetCrsMc.C
       /usr/bin/time root -b -q readMyJetCrsMc.C\(\"$INPUTFILE0\",\"pt4_5\.$JOBINDEX\.crs\.root\"\)
...
# Copy output files (if any where specified)
    ...
    foreach file ( $SCRATCH/pt4_5.$JOBINDEX.crs.root )
         set i=0
         
         if ( -d $file ) then
            set cpCommand="/bin/cp -r $file /star/u/zchang/data05/Run12JetsCrsUe/pt4_5/"
         else
            set cpCommand="/bin/cp -fp $file /star/u/zchang/data05/Run12JetsCrsUe/pt4_5/"
         endif
