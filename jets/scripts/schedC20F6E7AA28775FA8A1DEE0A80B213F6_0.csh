#!/bin/csh
# -------------------------------------- 
# Script generated on Tue Dec 04 10:41:47 EST 2018 by the STAR Unified Meta Scheduler 1.10.28 and submitted with:
# cd /star/u/zchang/jetAnalysis/jets; condor_submit /star/u/zchang/jetAnalysis/jets/scripts/schedC20F6E7AA28775FA8A1DEE0A80B213F6_0_9.condor
# --------------------------------------
...
setenv FILEBASENAME "pt20_25"
setenv FILELIST "/star/u/zchang/jetAnalysis/jets/scripts/schedC20F6E7AA28775FA8A1DEE0A80B213F6_0.list"
setenv FILELIST_ALL "/star/u/zchang/jetAnalysis/jets/scripts/schedC20F6E7AA28775FA8A1DEE0A80B213F6.list"
setenv INPUTFILECOUNT "1"
setenv JOBID "C20F6E7AA28775FA8A1DEE0A80B213F6_0"
setenv JOBINDEX "0"
setenv LOGGING "STD"
setenv REQUESTID "C20F6E7AA28775FA8A1DEE0A80B213F6"
...
setenv SUBMIT_TIME "2018-12-04 15:41:47"
setenv SUMS_AUTHENTICATED_USER "zchang@rhic.bnl.gov"
setenv SUMS_USER "zchang"
setenv SUMS_nProcesses "10"
setenv SUMS_name "pt20_25.job"
setenv INPUTFILE0 "/star/u/zchang/jetAnalysis/jets/lists_jets/pt20_25.0.list"
...
# User command BEGIN ----------------------------->
        ...
        echo pt20_25 readMyJetCrsMc.C
       /usr/bin/time root -b -q readMyJetCrsMc.C\(\"$INPUTFILE0\",\"pt20_25\.$JOBINDEX\.crs\.root\"\)
...
# Copy output files (if any where specified)
    ...
    foreach file ( $SCRATCH/pt20_25.$JOBINDEX.crs.root )
         set i=0
         
         if ( -d $file ) then
            set cpCommand="/bin/cp -r $file /star/u/zchang/data05/Run12JetsCrsUe/pt20_25/"
         else
            set cpCommand="/bin/cp -fp $file /star/u/zchang/data05/Run12JetsCrsUe/pt20_25/"
         endif
