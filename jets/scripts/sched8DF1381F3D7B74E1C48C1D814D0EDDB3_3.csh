#!/bin/csh
# -------------------------------------- 
# Script generated on Tue Dec 04 10:41:39 EST 2018 by the STAR Unified Meta Scheduler 1.10.28 and submitted with:
# cd /star/u/zchang/jetAnalysis/jets; condor_submit /star/u/zchang/jetAnalysis/jets/scripts/sched8DF1381F3D7B74E1C48C1D814D0EDDB3_0_9.condor
# --------------------------------------
...
setenv FILEBASENAME "pt11_15"
setenv FILELIST "/star/u/zchang/jetAnalysis/jets/scripts/sched8DF1381F3D7B74E1C48C1D814D0EDDB3_3.list"
setenv FILELIST_ALL "/star/u/zchang/jetAnalysis/jets/scripts/sched8DF1381F3D7B74E1C48C1D814D0EDDB3.list"
setenv INPUTFILECOUNT "1"
setenv JOBID "8DF1381F3D7B74E1C48C1D814D0EDDB3_3"
setenv JOBINDEX "3"
setenv LOGGING "STD"
setenv REQUESTID "8DF1381F3D7B74E1C48C1D814D0EDDB3"
...
setenv SUBMIT_TIME "2018-12-04 15:41:39"
setenv SUMS_AUTHENTICATED_USER "zchang@rhic.bnl.gov"
setenv SUMS_USER "zchang"
setenv SUMS_nProcesses "10"
setenv SUMS_name "pt11_15.job"
setenv INPUTFILE0 "/star/u/zchang/jetAnalysis/jets/lists_jets/pt11_15.3.list"
...
# User command BEGIN ----------------------------->
        ...
        echo pt11_15 readMyJetCrsMc.C
       /usr/bin/time root -b -q readMyJetCrsMc.C\(\"$INPUTFILE0\",\"pt11_15\.$JOBINDEX\.crs\.root\"\)
...
# Copy output files (if any where specified)
    ...
    foreach file ( $SCRATCH/pt11_15.$JOBINDEX.crs.root )
         set i=0
         
         if ( -d $file ) then
            set cpCommand="/bin/cp -r $file /star/u/zchang/data05/Run12JetsCrsUe/pt11_15/"
         else
            set cpCommand="/bin/cp -fp $file /star/u/zchang/data05/Run12JetsCrsUe/pt11_15/"
         endif
