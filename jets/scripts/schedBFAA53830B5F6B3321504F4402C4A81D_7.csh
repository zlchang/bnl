#!/bin/csh
# -------------------------------------- 
# Script generated on Tue Dec 04 10:41:59 EST 2018 by the STAR Unified Meta Scheduler 1.10.28 and submitted with:
# cd /star/u/zchang/jetAnalysis/jets; condor_submit /star/u/zchang/jetAnalysis/jets/scripts/schedBFAA53830B5F6B3321504F4402C4A81D_0_9.condor
# --------------------------------------
...
setenv FILEBASENAME "pt45_55"
setenv FILELIST "/star/u/zchang/jetAnalysis/jets/scripts/schedBFAA53830B5F6B3321504F4402C4A81D_7.list"
setenv FILELIST_ALL "/star/u/zchang/jetAnalysis/jets/scripts/schedBFAA53830B5F6B3321504F4402C4A81D.list"
setenv INPUTFILECOUNT "1"
setenv JOBID "BFAA53830B5F6B3321504F4402C4A81D_7"
setenv JOBINDEX "7"
setenv LOGGING "STD"
setenv REQUESTID "BFAA53830B5F6B3321504F4402C4A81D"
...
setenv SUBMIT_TIME "2018-12-04 15:41:59"
setenv SUMS_AUTHENTICATED_USER "zchang@rhic.bnl.gov"
setenv SUMS_USER "zchang"
setenv SUMS_nProcesses "10"
setenv SUMS_name "pt45_55.job"
setenv INPUTFILE0 "/star/u/zchang/jetAnalysis/jets/lists_jets/pt45_55.7.list"
...
# User command BEGIN ----------------------------->
        ...
        echo pt45_55 readMyJetCrsMc.C
       /usr/bin/time root -b -q readMyJetCrsMc.C\(\"$INPUTFILE0\",\"pt45_55\.$JOBINDEX\.crs\.root\"\)
...
# Copy output files (if any where specified)
    ...
    foreach file ( $SCRATCH/pt45_55.$JOBINDEX.crs.root )
         set i=0
         
         if ( -d $file ) then
            set cpCommand="/bin/cp -r $file /star/u/zchang/data05/Run12JetsCrsUe/pt45_55/"
         else
            set cpCommand="/bin/cp -fp $file /star/u/zchang/data05/Run12JetsCrsUe/pt45_55/"
         endif
