#!/bin/csh
# -------------------------------------- 
# Script generated on Tue Dec 04 10:41:33 EST 2018 by the STAR Unified Meta Scheduler 1.10.28 and submitted with:
# cd /star/u/zchang/jetAnalysis/jets; condor_submit /star/u/zchang/jetAnalysis/jets/scripts/sched69FEDB396AB943757BAA3CDD702FB8BA_0_9.condor
# --------------------------------------
...
setenv FILEBASENAME "pt9_11"
setenv FILELIST "/star/u/zchang/jetAnalysis/jets/scripts/sched69FEDB396AB943757BAA3CDD702FB8BA_6.list"
setenv FILELIST_ALL "/star/u/zchang/jetAnalysis/jets/scripts/sched69FEDB396AB943757BAA3CDD702FB8BA.list"
setenv INPUTFILECOUNT "1"
setenv JOBID "69FEDB396AB943757BAA3CDD702FB8BA_6"
setenv JOBINDEX "6"
setenv LOGGING "STD"
setenv REQUESTID "69FEDB396AB943757BAA3CDD702FB8BA"
...
setenv SUBMIT_TIME "2018-12-04 15:41:33"
setenv SUMS_AUTHENTICATED_USER "zchang@rhic.bnl.gov"
setenv SUMS_USER "zchang"
setenv SUMS_nProcesses "10"
setenv SUMS_name "pt9_11.job"
setenv INPUTFILE0 "/star/u/zchang/jetAnalysis/jets/lists_jets/pt9_11.6.list"
...
# User command BEGIN ----------------------------->
        ...
        echo pt9_11 readMyJetCrsMc.C
       /usr/bin/time root -b -q readMyJetCrsMc.C\(\"$INPUTFILE0\",\"pt9_11\.$JOBINDEX\.crs\.root\"\)
...
# Copy output files (if any where specified)
    ...
    foreach file ( $SCRATCH/pt9_11.$JOBINDEX.crs.root )
         set i=0
         
         if ( -d $file ) then
            set cpCommand="/bin/cp -r $file /star/u/zchang/data05/Run12JetsCrsUe/pt9_11/"
         else
            set cpCommand="/bin/cp -fp $file /star/u/zchang/data05/Run12JetsCrsUe/pt9_11/"
         endif
