#!/bin/csh
# -------------------------------------- 
# Script generated on Tue Dec 04 10:41:55 EST 2018 by the STAR Unified Meta Scheduler 1.10.28 and submitted with:
# cd /star/u/zchang/jetAnalysis/jets; condor_submit /star/u/zchang/jetAnalysis/jets/scripts/sched23AE891667E25BB0EA7F2B43F78244F0_0_9.condor
# --------------------------------------
...
setenv FILEBASENAME "pt35_45"
setenv FILELIST "/star/u/zchang/jetAnalysis/jets/scripts/sched23AE891667E25BB0EA7F2B43F78244F0_9.list"
setenv FILELIST_ALL "/star/u/zchang/jetAnalysis/jets/scripts/sched23AE891667E25BB0EA7F2B43F78244F0.list"
setenv INPUTFILECOUNT "1"
setenv JOBID "23AE891667E25BB0EA7F2B43F78244F0_9"
setenv JOBINDEX "9"
setenv LOGGING "STD"
setenv REQUESTID "23AE891667E25BB0EA7F2B43F78244F0"
...
setenv SUBMIT_TIME "2018-12-04 15:41:55"
setenv SUMS_AUTHENTICATED_USER "zchang@rhic.bnl.gov"
setenv SUMS_USER "zchang"
setenv SUMS_nProcesses "10"
setenv SUMS_name "pt35_45.job"
setenv INPUTFILE0 "/star/u/zchang/jetAnalysis/jets/lists_jets/pt35_45.9.list"
...
# User command BEGIN ----------------------------->
        ...
        echo pt35_45 readMyJetCrsMc.C
       /usr/bin/time root -b -q readMyJetCrsMc.C\(\"$INPUTFILE0\",\"pt35_45\.$JOBINDEX\.crs\.root\"\)
...
# Copy output files (if any where specified)
    ...
    foreach file ( $SCRATCH/pt35_45.$JOBINDEX.crs.root )
         set i=0
         
         if ( -d $file ) then
            set cpCommand="/bin/cp -r $file /star/u/zchang/data05/Run12JetsCrsUe/pt35_45/"
         else
            set cpCommand="/bin/cp -fp $file /star/u/zchang/data05/Run12JetsCrsUe/pt35_45/"
         endif
