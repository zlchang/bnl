...
# cd /star/u/zchang/jetAnalysis/jets/working_6; condor_submit /star/u/zchang/jetAnalysis/jets/working_6/scripts/sched6C296208C17A3275B786CE2D72D2971F_0_2.condor
# --------------------------------------
...
setenv FILEBASENAME "13093023"
setenv FILELIST "/star/u/zchang/jetAnalysis/jets/working_6/scripts/sched6C296208C17A3275B786CE2D72D2971F_0.list"
setenv FILELIST_ALL "/star/u/zchang/jetAnalysis/jets/working_6/scripts/sched6C296208C17A3275B786CE2D72D2971F.list"
setenv INPUTFILECOUNT "1"
setenv JOBID "6C296208C17A3275B786CE2D72D2971F_0"
setenv JOBINDEX "0"
setenv LOGGING "STD"
setenv REQUESTID "6C296208C17A3275B786CE2D72D2971F"
...
setenv SUMS_name "13093023.job"
setenv INPUTFILE0 "/star/u/zchang/jetAnalysis/jets/lists_jets/13093023.0.list"
...
# User command BEGIN ----------------------------->
        ...
        echo 13093023 readMyJetCrs.C
       /usr/bin/time root -b -q readMyJetCrs.C\(\"$INPUTFILE0\",\"13093023\.$JOBINDEX\.crs\.root\"\)
...
# Copy output files (if any where specified)
    ...
    foreach file ( $SCRATCH/13093023.$JOBINDEX.crs.root )
         set i=0
         
         if ( -d $file ) then
            set cpCommand="/bin/cp -r $file /star/u/zchang/data05/Run12JetsCrsUe/13093023/"
         else
            set cpCommand="/bin/cp -fp $file /star/u/zchang/data05/Run12JetsCrsUe/13093023/"
         endif
