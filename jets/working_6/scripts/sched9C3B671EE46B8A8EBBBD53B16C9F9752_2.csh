...
# cd /star/u/zchang/jetAnalysis/jets/working_6; condor_submit /star/u/zchang/jetAnalysis/jets/working_6/scripts/sched9C3B671EE46B8A8EBBBD53B16C9F9752_0_2.condor
# --------------------------------------
...
setenv FILEBASENAME "13090021"
setenv FILELIST "/star/u/zchang/jetAnalysis/jets/working_6/scripts/sched9C3B671EE46B8A8EBBBD53B16C9F9752_2.list"
setenv FILELIST_ALL "/star/u/zchang/jetAnalysis/jets/working_6/scripts/sched9C3B671EE46B8A8EBBBD53B16C9F9752.list"
setenv INPUTFILECOUNT "1"
setenv JOBID "9C3B671EE46B8A8EBBBD53B16C9F9752_2"
setenv JOBINDEX "2"
setenv LOGGING "STD"
setenv REQUESTID "9C3B671EE46B8A8EBBBD53B16C9F9752"
...
setenv SUMS_name "13090021.job"
setenv INPUTFILE0 "/star/u/zchang/jetAnalysis/jets/lists_jets/13090021.2.list"
...
# User command BEGIN ----------------------------->
        ...
        echo 13090021 readMyJetCrs.C
       /usr/bin/time root -b -q readMyJetCrs.C\(\"$INPUTFILE0\",\"13090021\.$JOBINDEX\.crs\.root\"\)
...
# Copy output files (if any where specified)
    ...
    foreach file ( $SCRATCH/13090021.$JOBINDEX.crs.root )
         set i=0
         
         if ( -d $file ) then
            set cpCommand="/bin/cp -r $file /star/u/zchang/data05/Run12JetsCrsUe/13090021/"
         else
            set cpCommand="/bin/cp -fp $file /star/u/zchang/data05/Run12JetsCrsUe/13090021/"
         endif
