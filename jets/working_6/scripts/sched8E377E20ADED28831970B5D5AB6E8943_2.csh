#!/bin/csh
# -------------------------------------- 
# Script generated on Tue Dec 04 10:54:11 EST 2018 by the STAR Unified Meta Scheduler 1.10.28 and submitted with:
# cd /star/u/zchang/jetAnalysis/jets/working_6; condor_submit /star/u/zchang/jetAnalysis/jets/working_6/scripts/sched8E377E20ADED28831970B5D5AB6E8943_0_2.condor
# --------------------------------------
...
setenv FILEBASENAME "13100030"
setenv FILELIST "/star/u/zchang/jetAnalysis/jets/working_6/scripts/sched8E377E20ADED28831970B5D5AB6E8943_2.list"
setenv FILELIST_ALL "/star/u/zchang/jetAnalysis/jets/working_6/scripts/sched8E377E20ADED28831970B5D5AB6E8943.list"
setenv INPUTFILECOUNT "1"
setenv JOBID "8E377E20ADED28831970B5D5AB6E8943_2"
setenv JOBINDEX "2"
setenv LOGGING "STD"
setenv REQUESTID "8E377E20ADED28831970B5D5AB6E8943"
...
setenv SUBMIT_TIME "2018-12-04 15:54:11"
setenv SUMS_AUTHENTICATED_USER "zchang@rhic.bnl.gov"
setenv SUMS_USER "zchang"
setenv SUMS_nProcesses "3"
setenv SUMS_name "13100030.job"
setenv INPUTFILE0 "/star/u/zchang/jetAnalysis/jets/lists_jets/13100030.2.list"
...
# User command BEGIN ----------------------------->
        ...
        echo 13100030 readMyJetCrs.C
       /usr/bin/time root -b -q readMyJetCrs.C\(\"$INPUTFILE0\",\"13100030\.$JOBINDEX\.crs\.root\"\)
...
# Copy output files (if any where specified)
    ...
    foreach file ( $SCRATCH/13100030.$JOBINDEX.crs.root )
         set i=0
         
         if ( -d $file ) then
            set cpCommand="/bin/cp -r $file /star/u/zchang/data05/Run12JetsCrsUe/13100030/"
         else
            set cpCommand="/bin/cp -fp $file /star/u/zchang/data05/Run12JetsCrsUe/13100030/"
         endif
