...
{
  fillMcEvent(mJetPartonEvent, mJetParton, mJetYieldParton, false);
  fillMcEvent(mJetParticleEvent, mJetParticle, mJetYieldParticle, true);
  return 1;
}
...
void ReaderPythia::fillMcEvent(StJetEvent *jetParEvent, MyJetPar *jetPar, MyJetYieldPar *jetYield, bool flag)
{
